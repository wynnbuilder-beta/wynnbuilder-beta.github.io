...
export const idPrefixes: Record<string, string> = {
  displayName: '',
...
export const idSuffixes: Record<string, string> = {
  displayName: '',
  lvl: '',
  classReq: '',
  strReq: '',
...
export const consumableIDPrefixes: Record<string, string> = {
  charges: 'Charges: ',
  dura: 'Duration: ',
};

export const consumableIDSuffixes: Record<string, string> = {
  charges: '',
  dura: ' sec.',
};

// Used for ingredient itemIDs
export const itemIDPrefixes: Record<string, string> = {
  dura: 'Durability: ',
  strReq: 'Strength Min: ',
  dexReq: 'Dexterity Min: ',
  intReq: 'Intelligence Min: ',
...
export const posModPrefixes: Record<string, string> = {
...
export const posModSuffixes: Record<string, string> = {
  left: '%',
  right: '%',
  above: '%',
  under: '%',
...
export const build_overall_display_commands = [
  '#defense-stats',
  '!spacer',
  'mr',
  'ms',
...
export const build_detailed_display_commands = [
...
export const build_basic_display_commands = [
  '#defense-stats',
  'mr',
  'ms',
  'ls',
...
export const sq2_item_display_commands = [
  'displayName',
  'atkSpd',
  '!elemental',
  'hp',
...
export const sq2_ing_display_order = [
  'displayName',
  '!spacer',
  'ids',
  '!spacer',
